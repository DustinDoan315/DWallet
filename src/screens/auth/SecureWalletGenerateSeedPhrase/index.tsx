...
const SecureWalletGenerateSeedPhraseScreen = () => {
  ...
  const _renderSeedPhrases = (item: any, index: number) => {
    return (
            ...
            <View style={styles.seedPhraseColumns}>
              ...
              <View style={styles.column}>
                <FlatList
                  ...
                  renderItem={({ item, index }) =>
                    _renderSeedPhrases(item, index + 6)
                  }
                  keyExtractor={(_, index) => (index + 6).toString()}
                  scrollEnabled={false}
                />
              </View>
            </View>
...
export default SecureWalletGenerateSeedPhraseScreen;
